...
const (
	...
	AgentServiceName = "construct.v1.AgentService"
)
...
const (
	...
	// RPC.
	AgentServiceCreateAgentProcedure = "/construct.v1.AgentService/CreateAgent"
	// AgentServiceGetAgentProcedure is the fully-qualified name of the AgentService's GetAgent RPC.
	AgentServiceGetAgentProcedure = "/construct.v1.AgentService/GetAgent"
	// AgentServiceListAgentsProcedure is the fully-qualified name of the AgentService's ListAgents RPC.
	AgentServiceListAgentsProcedure = "/construct.v1.AgentService/ListAgents"
	// AgentServiceUpdateAgentProcedure is the fully-qualified name of the AgentService's UpdateAgent
	// RPC.
	AgentServiceUpdateAgentProcedure = "/construct.v1.AgentService/UpdateAgent"
	// AgentServiceDeleteAgentProcedure is the fully-qualified name of the AgentService's DeleteAgent
	// RPC.
	AgentServiceDeleteAgentProcedure = "/construct.v1.AgentService/DeleteAgent"
)

// AgentServiceClient is a client for the construct.v1.AgentService service.
...
// NewAgentServiceClient constructs a client for the construct.v1.AgentService service. By default,
...
func NewAgentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AgentServiceClient {
	...
	agentServiceMethods := v1.File_construct_v1_agent_proto.Services().ByName("AgentService").Methods()
...
// CreateAgent calls construct.v1.AgentService.CreateAgent.
...
// GetAgent calls construct.v1.AgentService.GetAgent.
...
// ListAgents calls construct.v1.AgentService.ListAgents.
...
// UpdateAgent calls construct.v1.AgentService.UpdateAgent.
...
// DeleteAgent calls construct.v1.AgentService.DeleteAgent.
...
// AgentServiceHandler is an implementation of the construct.v1.AgentService service.
...
func NewAgentServiceHandler(svc AgentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/construct.v1.AgentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAgentServiceHandler) CreateAgent(context.Context, *connect.Request[v1.CreateAgentRequest]) (*connect.Response[v1.CreateAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("construct.v1.AgentService.CreateAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) GetAgent(context.Context, *connect.Request[v1.GetAgentRequest]) (*connect.Response[v1.GetAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("construct.v1.AgentService.GetAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) ListAgents(context.Context, *connect.Request[v1.ListAgentsRequest]) (*connect.Response[v1.ListAgentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("construct.v1.AgentService.ListAgents is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) UpdateAgent(context.Context, *connect.Request[v1.UpdateAgentRequest]) (*connect.Response[v1.UpdateAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("construct.v1.AgentService.UpdateAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) DeleteAgent(context.Context, *connect.Request[v1.DeleteAgentRequest]) (*connect.Response[v1.DeleteAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("construct.v1.AgentService.DeleteAgent is not implemented"))
}
